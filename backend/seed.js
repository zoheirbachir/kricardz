...
async function seed() {
  ...
  /* Catalogue exact, calqué sur https://kricar-dz.com/search — photos, vidéos,
     descriptions, caution et kilométrage repris des fiches réelles. Les médias sont
     servis depuis /uploads/vehicles sur CE serveur (voir backend/uploads/vehicles) —
     ils vivaient auparavant sur l'ancien site à cette même adresse de domaine, qui
     n'existe plus depuis que kricar-dz.com sert cette application ; les fichiers
     originaux ont été récupérés depuis une sauvegarde puis replacés ici. */
  const U = '/uploads/vehicles/';
  const cars = [
