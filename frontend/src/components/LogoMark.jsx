/* DzKricar's icon mark: a car profile cut out of the brand's orange gradient disc.

   The car is a knockout — genuinely transparent — so whatever sits behind the
   mark shows through it: dark on a dark surface, light on a light one. The
   geometry matches scripts/generate-brand.cjs, which derives the favicon, app
   icon, splash screens and store graphics — keep them in sync.
  ...
  return (
    <svg viewBox="0 0 1024 1024" className={`${className} shrink-0`} xmlns="http://www.w3.org/2000/svg" role="img" aria-label="DzKricar">
      <defs>
        ...
        {/* White keeps the disc, the black stroke removes (cuts out) the car. */}
        <mask id="dzk-cut">
          <circle cx="512" cy="506" r="366" fill="#fff" />
          <path
            ...
            fill="none" stroke="#000" strokeWidth="46" strokeLinecap="round" strokeLinejoin="round"
          />
        </mask>
      </defs>
      <circle cx="512" cy="506" r="366" fill="url(#dzk-mark)" mask="url(#dzk-cut)" />
    </svg>
  );
}
